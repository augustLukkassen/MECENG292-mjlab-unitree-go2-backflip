...
def create_velocity_env_cfg(
  ...
  commands: dict[str, CommandTermCfg] = {
    "twist": UniformVelocityCommandCfg(
        ...
        # recommended ratios for locomotion
        rel_standing_envs=0.10,    # 10% standing
        rel_heading_envs=0.30,     # 30% heading-only
  ...
  critic_terms: dict[str, ObservationTermCfg] = {
    name: ObservationTermCfg(
        func=term.func,
        noise=None,  # No noise for critic
        params=term.params,
    )
 ...
 #   **policy_terms,
  ...
  rewards = {
    ...
    "upright": RewardTermCfg(
      ...
      params={
        "std": math.sqrt(0.2),
        "asset_cfg": SceneEntityCfg("robot", body_ids=[]),
      },
    ),
